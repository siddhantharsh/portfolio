...
const Project = ({
  ...
  return (
    <div className="flex flex-col gap-2 p-6 rounded-lg bg-neutral-900 border border-neutral-800 shadow-lg transition-all duration-300 hover:shadow-2xl hover:bg-neutral-800 hover:border-neutral-600 hover:scale-[1.02] hover:-translate-y-1">
